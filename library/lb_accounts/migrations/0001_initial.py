    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to='profile_photos/', validators=[library.core.validators.MaxFileSizeValidator(limit_value=10485760)], verbose_name='Profile Picture')),
